...
public static class ViewRecipeNodes
{
    ...
    [
        ...
        new ViewRecipeNode("categoryStyle", "Color source categories, with a distinct unknown category; optionally ghost the entire model.",
            [new("palette", ParamKind.Enum, "classic", ["classic", "vivid", "pastel", "earth", "grayscale"]),
                Slider("opacity", "1", 0, 1)],
            p => new { palette = Choice(p, "palette", "classic", "classic", "vivid", "pastel", "earth", "grayscale"),
                opacity = Range(p, "opacity", 1, 0, 1) }),
