...
/// <summary>Column lookup and row-ordinal machinery shared by the node packs:
/// case-insensitive column resolution, collision-free ordinal columns so
/// generated SQL never trusts scan order, and wire-kind naming.</summary>
