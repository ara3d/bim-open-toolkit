...
/// <summary>One statement (WITH n1 AS ..., nK AS ... SELECT * FROM nK) plus the sources it binds.</summary>
public sealed record CompiledQuery(string Sql, IReadOnlyList<SourceUse> Sources)
{
