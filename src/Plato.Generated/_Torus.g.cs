...
namespace Ara3D.Geometry
{
    ...
    public partial struct Torus: ISolid
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Eval(Vector2 uv){
            var u = uv.X.Turns;
            var v = uv.Y.Turns;
            return (this.MajorRadius.Add(this.MinorRadius.Multiply(v.Cos)).Multiply(u.Cos), this.MajorRadius.Add(this.MinorRadius.Multiply(v.Cos)).Multiply(u.Sin), this.MinorRadius.Multiply(v.Sin));
        }
