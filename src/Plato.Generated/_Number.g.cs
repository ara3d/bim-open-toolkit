...
public Angle ArcMinutes { [MethodImpl(AggressiveInlining)] get  => this.Divide(((Number)60)).Degrees; } 
public Angle ArcSeconds { [MethodImpl(AggressiveInlining)] get  => this.Divide(((Number)60)).ArcMinutes; } 
...
[MethodImpl(AggressiveInlining)] public Number InverseLerp(Number b, Number v) => v.Subtract(this).Divide(b.Subtract(this));
[MethodImpl(AggressiveInlining)] public Number Remap(Number inA, Number inB, Number outA, Number outB) => outA.Lerp(outB, inA.InverseLerp(inB, this));
...
[MethodImpl(AggressiveInlining)] public Number SineWave(Number amplitude, Number frequency, Number phase) => amplitude.Multiply(this.Multiply(frequency).Add(phase).Turns.Sin);
...
[MethodImpl(AggressiveInlining)] public Matrix4x4 Multiply(Matrix4x4 value1) => this * value1;
        ...
        [MethodImpl(AggressiveInlining)] public Number OpUnion(Number b) => this.Min(b);
[MethodImpl(AggressiveInlining)] public Number OpIntersect(Number b) => this.Max(b);
[MethodImpl(AggressiveInlining)] public Number OpSubtract(Number b) => this.Max(b.Negative);
[MethodImpl(AggressiveInlining)] public Number OpSmoothUnion(Number b, Number k){
            var h = ((Number)0.5).Add(((Number)0.5).Multiply(b.Subtract(this)).Divide(k)).Clamp(((Number)0), ((Number)1));
            return b.Lerp(this, h).Subtract(k.Multiply(h).Multiply(((Number)1).Subtract(h)));
        }

[MethodImpl(AggressiveInlining)] public Point2D NGonPoint(Integer n){
            var p = this.Fract.Multiply(n.Number);
            var f = p.Fract;
            var a = p.Floor.Divide(n.Number).Turns.UnitCircle;
            var b = p.Floor.Add(((Number)1)).Divide(n.Number).Turns.UnitCircle;
            return a.Lerp(b, f);
        }

public Point2D SquarePoint { [MethodImpl(AggressiveInlining)] get {
            var p = this.Fract.Multiply(((Number)4));
            var f = p.Fract;
            var c = ((Number)2).Sqrt;
            var a = p.Floor.Add(((Number)0.5)).Divide(((Number)4)).Turns.UnitCircle.Multiply(c);
            var b = p.Floor.Add(((Number)1.5)).Divide(((Number)4)).Turns.UnitCircle.Multiply(c);
            return a.Lerp(b, f);
        }
         } 
...
[MethodImpl(AggressiveInlining)]  public static implicit operator Vector8(Number s) => s.Vector8;
        [MethodImpl(AggressiveInlining)] public IReadOnlyList<Number> Sample(Number b, Integer n){
            ...
            {
                var _var81 = this;
                return n.LinearSpace.Map((i)  => _var81.Lerp(_var82, i));
            }
        }
...
[MethodImpl(AggressiveInlining)] public Number Greater(Number b) => this.GreaterThanOrEquals(b) ? this : b;
    ...
    public static class NumberExtensions
    {
        ...
        [MethodImpl(AggressiveInlining)] public static Number Linear(this Number self, Number a, Number b) => self.Linear(a, b);
        [MethodImpl(AggressiveInlining)] public static Number Linear(this float self, Number a, Number b) => ((Number)self).Linear(a, b);
        [MethodImpl(AggressiveInlining)] public static Number Quadratic(this Number self, Number a, Number b, Number c) => self.Quadratic(a, b, c);
        [MethodImpl(AggressiveInlining)] public static Number Quadratic(this float self, Number a, Number b, Number c) => ((Number)self).Quadratic(a, b, c);
        [MethodImpl(AggressiveInlining)] public static Number Cubic(this Number self, Number a, Number b, Number c, Number d) => self.Cubic(a, b, c, d);
        [MethodImpl(AggressiveInlining)] public static Number Cubic(this float self, Number a, Number b, Number c, Number d) => ((Number)self).Cubic(a, b, c, d);
        [MethodImpl(AggressiveInlining)] public static Angle Angle(this Number x) => x.Angle;
