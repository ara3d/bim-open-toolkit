...
[MethodImpl(AggressiveInlining)] public Point3D RoundToZero(Integer digits){
            var _var58 = digits;
            return this.MapComponents((x)  => x.RoundToZero(_var58));
        }

[MethodImpl(AggressiveInlining)] public Point3D ScaleB(Integer n){
            var _var59 = n;
            return this.MapComponents((x)  => x.ScaleB(_var59));
        }
...
[MethodImpl(AggressiveInlining)] public Point3D Lerp(Point3D b, Number t){
            var _var60 = t;
            return this.ZipComponents(b, (a1, b1)  => a1.Lerp(b1, _var60));
        }
...
[MethodImpl(AggressiveInlining)] public IReadOnlyList<Point3D> Sample(Point3D b, Integer n){
            ...
            {
                var _var61 = this;
                return n.LinearSpace.Map((i)  => _var61.Lerp(_var62, i));
            }
        }
...
public Number this[Integer n] { [MethodImpl(AggressiveInlining)]  get => At(n); }
        public Point3D Reverse { [MethodImpl(AggressiveInlining)] get  => Point3D.CreateFromComponents(this.Components.Reverse()); } 
...
[MethodImpl(AggressiveInlining)] public Point3D Transform(Transform3D t){
            var _var63 = t;
            return this.Deform((p)  => p.Vector3.Transform(_var63.Matrix));
        }

[MethodImpl(AggressiveInlining)] public Point3D Scale(Vector3 v) => this.Transform(new Scaling3D(v));
...
[MethodImpl(AggressiveInlining)] public Point3D Rotate(Quaternion q) => this.Transform(new Rotation3D(q));
...
[MethodImpl(AggressiveInlining)] public Point3D Translate(Vector3 v) => this.Transform(new Translation3D(v));
