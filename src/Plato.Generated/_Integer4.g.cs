...
public Integer this[Integer n] { [MethodImpl(AggressiveInlining)]  get => At(n); }
        public Integer4 Reverse { [MethodImpl(AggressiveInlining)] get  => Integer4.CreateFromComponents(this.Components.Reverse()); } 
[MethodImpl(AggressiveInlining)] public Integer4 MapComponents(System.Func<Integer, Integer> f) => Integer4.CreateFromComponents(this.Components.Map(f));
[MethodImpl(AggressiveInlining)] public Integer4 ZipComponents(Integer4 b, System.Func<Integer, Integer, Integer> f) => Integer4.CreateFromComponents(this.Components.Zip(b.Components, f));
[MethodImpl(AggressiveInlining)] public Integer4 ZipComponents(Integer4 b, Integer4 c, System.Func<Integer, Integer, Integer, Integer> f) => Integer4.CreateFromComponents(this.Components.Zip(b.Components, c.Components, f));
[MethodImpl(AggressiveInlining)] public Boolean AllZipComponents(Integer4 b, System.Func<Integer, Integer, Boolean> f) => this.Components.Zip(b.Components, f).All((x)  => x);
[MethodImpl(AggressiveInlining)] public Boolean AllZipComponents(Integer4 b, Integer4 c, System.Func<Integer, Integer, Integer, Boolean> f) => this.Components.Zip(b.Components, c.Components, f).All((x)  => x);
[MethodImpl(AggressiveInlining)] public Boolean AnyZipComponents(Integer4 b, System.Func<Integer, Integer, Boolean> f) => this.Components.Zip(b.Components, f).Any((x)  => x);
[MethodImpl(AggressiveInlining)] public Boolean AnyZipComponents(Integer4 b, Integer4 c, System.Func<Integer, Integer, Integer, Boolean> f) => this.Components.Zip(b.Components, c.Components, f).Any((x)  => x);
