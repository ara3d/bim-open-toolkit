...
[MethodImpl(AggressiveInlining)] public Point2D RoundToZero(Integer digits){
            var _var45 = digits;
            return this.MapComponents((x)  => x.RoundToZero(_var45));
        }

[MethodImpl(AggressiveInlining)] public Point2D ScaleB(Integer n){
            var _var46 = n;
            return this.MapComponents((x)  => x.ScaleB(_var46));
        }
...
[MethodImpl(AggressiveInlining)] public Point2D Lerp(Point2D b, Number t){
            var _var47 = t;
            return this.ZipComponents(b, (a1, b1)  => a1.Lerp(b1, _var47));
        }
...
[MethodImpl(AggressiveInlining)] public IReadOnlyList<Point2D> Sample(Point2D b, Integer n){
            ...
            {
                var _var48 = this;
                return n.LinearSpace.Map((i)  => _var48.Lerp(_var49, i));
            }
        }
...
public Number this[Integer n] { [MethodImpl(AggressiveInlining)]  get => At(n); }
        public Point2D Reverse { [MethodImpl(AggressiveInlining)] get  => Point2D.CreateFromComponents(this.Components.Reverse()); } 
