...
// Created on 2026-07-10 11:15:10 PM
...
namespace Ara3D.Geometry
{
    ...
    public partial struct Tube: ISolid
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Eval(Vector2 uv){
            ...
            var r = uv.Y.LessThan(((Number)0.5)) ? this.OuterRadius : this.InnerRadius;
            var z = (uv.Y.LessThan(((Number)0.5)) ? uv.Y.Multiply(((Number)2)).Subtract(((Number)0.5)) : ((Number)1.5).Subtract(uv.Y.Multiply(((Number)2)))).Multiply(this.Height);
            return (theta.Cos.Multiply(r), theta.Sin.Multiply(r), z);
        }
