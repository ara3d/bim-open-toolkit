...
[MethodImpl(AggressiveInlining)] public Bounds3D Transform(Transform3D t){
            var _var64 = t;
            return this.Deform((p)  => p.Vector3.Transform(_var64.Matrix));
        }

[MethodImpl(AggressiveInlining)] public Bounds3D Scale(Vector3 v) => this.Transform(new Scaling3D(v));
...
[MethodImpl(AggressiveInlining)] public Bounds3D Rotate(Quaternion q) => this.Transform(new Rotation3D(q));
...
[MethodImpl(AggressiveInlining)] public Bounds3D Translate(Vector3 v) => this.Transform(new Translation3D(v));
...
public Point3D this[Integer n] { [MethodImpl(AggressiveInlining)]  get => At(n); }
        public Bounds3D Reverse { [MethodImpl(AggressiveInlining)] get  => Bounds3D.CreateFromComponents(this.Components.Reverse()); } 
