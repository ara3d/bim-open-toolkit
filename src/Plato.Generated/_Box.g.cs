...
namespace Ara3D.Geometry
{
    ...
    public partial struct Box: ISolid
    {
        ...
        [MethodImpl(AggressiveInlining)] public Point3D Eval(Vector2 uv){
            ...
            return (p.X.Multiply(this.Extent.X).Multiply(((Number)0.5)), p.Y.Multiply(this.Extent.Y).Multiply(((Number)0.5)), uv.Y.Subtract(((Number)0.5)).Multiply(this.Extent.Z));
        }
