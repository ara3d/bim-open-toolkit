...
namespace Ara3D.Geometry
{
    ...
    public partial struct Triangle3D: IDeformable3D<Triangle3D>, IArrayLike<Triangle3D, Point3D>
    {
        ...
        public Number Area { [MethodImpl(AggressiveInlining)] get  => this.CrossProductA.Magnitude.Half; } 
...
[MethodImpl(AggressiveInlining)] public Triangle3D Scale(Vector3 v) => this.Transform(new Scaling3D(v));
...
[MethodImpl(AggressiveInlining)] public Triangle3D Rotate(Quaternion q) => this.Transform(new Rotation3D(q));
...
[MethodImpl(AggressiveInlining)] public Triangle3D Translate(Vector3 v) => this.Transform(new Translation3D(v));
...
public Point3D this[Integer n] { [MethodImpl(AggressiveInlining)]  get => At(n); }
        public Triangle3D Reverse { [MethodImpl(AggressiveInlining)] get  => Triangle3D.CreateFromComponents(this.Components.Reverse()); } 
