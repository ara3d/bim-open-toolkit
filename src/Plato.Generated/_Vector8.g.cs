...
public Vector8 FromOne { [MethodImpl(AggressiveInlining)] get  => this.Negative.Add(One); } 
...
public Vector8 SmoothStep { [MethodImpl(AggressiveInlining)] get  => this.Sqr.Multiply(this.Twice.Negative.Add(((Number)3))); } 
public Vector8 SmootherStep { [MethodImpl(AggressiveInlining)] get  => this.Pow3.Multiply(this.Multiply(this.Multiply(((Number)6)).Subtract(((Number)15))).Add(((Number)10))); } 
...
[MethodImpl(AggressiveInlining)] public Vector8 RoundToZero(Integer digits){
            var _var109 = digits;
            return this.MapComponents((x)  => x.RoundToZero(_var109));
        }

[MethodImpl(AggressiveInlining)] public Vector8 ScaleB(Integer n){
            var _var110 = n;
            return this.MapComponents((x)  => x.ScaleB(_var110));
        }
...
[MethodImpl(AggressiveInlining)] public Vector8 Lerp(Vector8 b, Number t){
            var _var111 = t;
            return this.ZipComponents(b, (a1, b1)  => a1.Lerp(b1, _var111));
        }
...
[MethodImpl(AggressiveInlining)] public IReadOnlyList<Vector8> Sample(Vector8 b, Integer n){
            ...
            {
                var _var112 = this;
                return n.LinearSpace.Map((i)  => _var112.Lerp(_var113, i));
            }
        }
...
public Number this[Integer n] { [MethodImpl(AggressiveInlining)]  get => At(n); }
        public Vector8 Reverse { [MethodImpl(AggressiveInlining)] get  => Vector8.CreateFromComponents(this.Components.Reverse()); } 
