...
| R2 render and headless read `meshTable` (F2 blocker) | Opus | `viewer/packages/render/**`, `viewer/packages/testing/src/headless/**` | working | `viewer/packages/render/docs/CHECKPOINT-R2.md` | `viewer/packages/formats/docs/CHECKPOINT-F2.md` |
