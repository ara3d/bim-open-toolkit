...
The Ask box and the MCP server behind it are described in [Building a DuckDB BIM Flow graph from natural language](bim-flow-mcp-demo.md), including the model key the Ask box needs.
