// Serves `ambient-occlusion.html` from the demos package with the V2 packages resolved to source.
//
...
// which is what tsc sees for the alpha packages. Port 5177: 5176 is the slice's and the gallery's.
//
// Run from `viewer/`: npx vite --config packages/demos/vite.ao.config.mjs
