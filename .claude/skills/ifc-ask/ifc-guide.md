...
- StoreyOfEntity(EntityIndex, StoreyIndex, StoreyName, Depth). The building storey above an entity, walking containment, aggregation and membership. Join it to group anything by storey.
